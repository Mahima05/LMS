                ...
                <Animated.View style={[styles.mainContent, { opacity: fadeAnim }]}>
                    ...
                    <ScrollView
                        ...
                        <ScrollView
                            ...
                            style={styles.horizontalSectionContainer}
                        >
...
const styles = StyleSheet.create({
    ...
    //     paddingHorizontal: 15,
    //     letterSpacing: 0.5,
    //     // Removed numberOfLines, flexWrap, and whiteSpace
    // },
...
//                                         opacity: statsCardAnims[index],
//                                         transform: [{
//                                             scale: statsCardAnims[index].interpolate({
//                                                 inputRange: [0, 1],
//                                                 outputRange: [0.8, 1],
//                                             }),
//                                         }],
...
//                                         end={{ x: 1, y: 1 }}
//                                     >
//                                         <Ionicons name={stat.icon} size={30} color="#fff" style={styles.statsIcon} />
//                                         <Text style={styles.statsValue}>{stat.value}</Text>
//                                         <Text style={styles.statsLabel}>{stat.label}</Text>
//                                     </LinearGradient>
//                                 </TouchableOpacity>
...
//                         {/* 3 Navigation Buttons - Keep visible */}
//                         <View style={styles.navTabsContainer}>
//                             <TouchableOpacity
//                                 style={styles.navTab}
//                                 activeOpacity={0.90}
...
//                         {/* NOTHING BELOW - All sections removed! */}
//                         <View style={{ height: 100 }} />
